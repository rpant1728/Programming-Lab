...
public class SealingUnit extends Thread {
    ...
    public SealingUnit(UnfinishedTray unfinishedTray, SealingUnitBuffer sealUnittray, PackingUnitBuffer packingUnitTray, Semaphore sem, Semaphore packingSem,
            Semaphore sealingSem, Semaphore godownSem, Time timer, Godown godown, Bottles bottles) {
        this.unfinishedTray = unfinishedTray;
        this.sealBuffer = sealUnittray;
        this.packBuffer = packingUnitTray;
